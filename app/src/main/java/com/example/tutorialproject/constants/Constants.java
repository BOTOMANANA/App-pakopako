...
public class Constants {
	...
	public static final String LOADING_DELETE_TOAST = "En cours de nettoyage";
	public static final String NO_DATA_DELETE_TOAST = "Aucun donnees a supprimer ! desole";
	public static final String EMPTY_ERROR_EDITTEXT = "Erreur le champ est vide";
	public static final String TEXT_PASSWORD = "Mot de passe";
	public static final String INCORRECT_PASSWORD = "Votre mot de passe est incorrect";
	public static final String FINGERPRINT_TITLE = "Empreinte digitale";
	public static final String FINGERPRINT_SUBTITLE = "Déverrouillez avec votre empreinte";
	public static final String FINGERPRINT_BUTTON = "Annuler";
}
